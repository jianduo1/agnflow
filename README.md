...
| 智能体类型 | 代码示例 | 流程图 |
|:----------:|:--------|:------:|
| **监督者智能体** | `s1[n1, n2, n3] >> n4` | <img src="assets/supervisor_mermaid.png" height="150" alt="监督者智能体流程图"> |
| **基础蜂群连接** | `s1[n1, n2, n3]` | <img src="assets/swarm_mermaid1.png" height="150" alt="基础蜂群连接流程图"> |
