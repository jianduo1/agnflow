...
from .utils import (
    call_llm, get_embedding, search_web_duckduckgo,
    create_memory_system, create_rag_system, create_tool_manager,
    MCPToolManager, ConversationMemory, RAGSystem
)
...
class LLMNode(Node):
    ...
    def __init__(self, name: str = "llm_node", model: str = "glm-4-flashx-250414", 
                 system_prompt: str = None, output_format: str = "text"):
